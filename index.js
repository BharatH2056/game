        ...
        window.addEventListener('oracle:prefetch', (e) => {
            ...
            buttons.forEach(btn => {
                ...
                if (actionKey === prediction.action) {
                    ...
                    btn.classList.remove('oracle-collective', 'oracle-intuitive', 'oracle-spatial', 'synapse-lock', 'guidance-aura', 'soma-lock', 'mnemosyne-recall', 'oracle-janus');
                    ...
                    btn.classList.remove('oracle-hint', 'oracle-intuitive', 'oracle-collective', 'oracle-spatial', 'synapse-lock', 'guidance-aura', 'soma-lock', 'mnemosyne-recall', 'argus-focus', 'oracle-janus');
                }
            });
