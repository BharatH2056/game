...
export class Oracle {
    ...
    predictNext(currentRoom, fullContext = null) {
        ...
        return {
            ...
            reason: best.traitBoosted ? "Intuition based on your playstyle" : (best.isContextual ? "Pattern matched your inventory" : "Common path taken by others")
        };
    }
