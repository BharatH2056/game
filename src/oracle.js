...
export class Oracle {
    constructor() {
        ...
        this.layerWeights = { base: 1.0, context: 5.0, recency: 2.0, trait: 8.0, collective: 2.0, spatial: 2.0 };
        this.layerAccuracy = { base: 0, context: 0, recency: 0, trait: 0, collective: 0, spatial: 0 };
    ...
    predictNext(currentRoomId, fullContext = null) {
        ...
        return {
            ...
            reason: best.isEcho ? `Collective wisdom of other ${archetype}s` :
